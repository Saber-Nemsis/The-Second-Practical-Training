...
public class ReadPropUtil {
    ...
    public static String getPropertyValue(String key) {
        InputStream in = com.appiumPlus.utils.ReadPropUtil.class.getClassLoader().getResourceAsStream(filePath);
        try {
            prop.load(in);
            in.close();
        } catch (IOException e) {
    ...
    public static String[] getPropSplitValues(String key) {
        InputStream in;
        try {
            in = com.appiumPlus.utils.ReadPropUtil.class.getClassLoader().getResourceAsStream(filePath);
            prop.load(in);
            in.close();
        } catch (Exception e) {
            e.printStackTrace();
